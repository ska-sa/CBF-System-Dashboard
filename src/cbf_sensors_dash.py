...
if __name__ == "__main__":
    ...
    if not args.get("sensor_path"):
        ...
        try:
            ...
            raise RuntimeError("No json dump file. Exiting!!!")
    else:
    ...
    app.layout = html.Div(
        ...
        html.Div([
            html.Div(id="content-container"), # Each "page" will modify this element
            dcc.Location(id="url", refresh=False), # This Location component represents the URL bar
            ]),
    ...
    def display_page(pathname):
        ...
        if pathname == "/":
            ...
            return html.Div([
                html.A("I guess this is like a 404 - no content available. Click to Go Home",
                    href="/")])
